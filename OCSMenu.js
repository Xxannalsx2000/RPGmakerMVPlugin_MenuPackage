...
//=============================================================================
/*:
 * @plugindesc 基於惡靈古堡的唯一角色的改變選單。
 * @author Alanderson zelindro da rosa(翻譯 : ReIris)
 *
 * @param mp_bar
 * @text 是否顯示 MP 條
 * @desc 設定為 true 將顯示 MP 條。
 * 預設 : false (不顯示)
 * @default false
 *
 * @param t_document
 ...
 * 在資料庫設定即可。
 *
 * 作者 : Alanderson zelindro da rosa
 * 網站 : http://zelindrodeveloper.blogspot.com/
 * 聯絡 : alandersonzelindrodr@gmail.com
 * FaceBook : https://www.facebook.com/alanderson.darosa
 *
 */
